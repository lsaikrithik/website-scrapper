...
def main():
    ...
    parser.add_argument("-u", "--url", type=str, default="https://web.archive.org/web/20200518073855/https://www.empireonline.com/movies/features/best-movies-2/", help="URL of the movie list.")
